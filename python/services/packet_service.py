...
def sml_packet_builder(wid, ver, idx, offset, mgid, vector):
    ...
    sml = SwitchMLPacket(wid=wid, ver=ver, idx=idx, offset=offset, mgid=mgid, size=CHUNK_SIZE, type=0)
    data = DataPacket(value00=data[0], value01=data[1], value02=data[2], value03=data[3], 
                      value04=data[4], value05=data[5], value06=data[6], value07=data[7],
                      value08=data[8], value09=data[9], value10=data[10], value11=data[11],
